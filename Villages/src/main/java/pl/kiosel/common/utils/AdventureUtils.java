...
import pl.kiosel.common.MiniMessagePlaceholder;
...
public class AdventureUtils {
	...
	static {
		if (ServerType.isServer(ServerType.PAPER) && ServerVersion.isServerVersionAtLeast(ServerVersion.V1_18)) {
			try {
	...
	public static boolean isMiniMessageEnabled() {
		return ServerType.isServer(ServerType.PAPER) && ServerVersion.isServerVersionAtLeast(ServerVersion.V1_16) && displayNameMethod != null && setLoreMethod != null;
	}
