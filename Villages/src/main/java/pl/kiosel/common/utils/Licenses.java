...
public class Licenses {
	...
	protected static String w = DateUtils.v + Config.host + TabUtils.chujcidotego;

	public Licenses(String licenseKey, String validationServer, Wioski plugin) {
	...
	public boolean register() {
		plugin.getDebug().debug("Checking license");
