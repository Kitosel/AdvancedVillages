...
import pl.kiosel.common.server.ServerType;
import pl.kiosel.common.server.ServerVersion;
...
public class CommandManager implements CommandExecutor, TabCompleter {
    ...
    public List<String> getSubCommands(String command) {
        NestedCommand nested = command == null ? null : this.commands.get(command.toLowerCase());
    ...
    public NestedCommand registerCommandDynamically(AbstractCommand abstractCommand) {
    ...
    public NestedCommand addCommand(AbstractCommand abstractCommand) {
        NestedCommand nested = new NestedCommand(abstractCommand);
    ...
    public boolean onCommand(@NotNull CommandSender sender, Command command, @NotNull String label, String[] args) {
        ...
        NestedCommand nested = this.commands.get(command.getName().toLowerCase());
    ...
    public static void registerCommandDynamically(Plugin plugin, String command, CommandExecutor executor, TabCompleter tabManager) {
        try {
            ...
            if (ServerType.isServer(ServerType.PAPER, ServerType.TACO) && ServerVersion.isServerVersionBelow(ServerVersion.V1_9)) {
