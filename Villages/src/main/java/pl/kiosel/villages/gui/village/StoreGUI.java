...
public final class StoreGUI extends VillageMenu {

	public StoreGUI(AdvancedVillages plugin, VillageGUIManager menus, Village village,
	...
	private void buyItem(int price, ItemStack item) {
		if (!hasPermission(VillagePermission.STORE)) {
			return;
		}
