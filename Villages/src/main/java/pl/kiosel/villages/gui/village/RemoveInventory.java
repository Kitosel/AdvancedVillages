...
public final class RemoveInventory extends VillageConfirmationMenu {

	public RemoveInventory(AdvancedVillages plugin, Village village, Player player, Gui parent) {
