...
public final class QuestGUI extends VillageMenu {

	public QuestGUI(AdvancedVillages plugin, VillageGUIManager menus, Village village,
		...
		if (views.isEmpty()) {
			GuiItemConfig empty = item("empty", 13, Material.BARRIER,
