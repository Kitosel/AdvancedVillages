...
import pl.kiosel.villages.addons.development.DevelopmentBonus;
import pl.kiosel.villages.addons.development.DevelopmentNode;
import pl.kiosel.villages.addons.development.DevelopmentPurchaseResult;
...
public final class DevelopmentInventory extends VillageMenu {
	private static final int[] DEFAULT_NODE_SLOTS = {11, 13, 15, 20, 22, 24, 29, 31, 33};

	public DevelopmentInventory(AdvancedVillages plugin, VillageGUIManager menus, Village village,
	...
	private void purchase(DevelopmentNode node) {
		if (!hasPermission(Permission.DEVELOPMENT_BUY)) return;
