...
public final class MemberRemoveInventory extends VillageConfirmationMenu {

	private final UUID memberId;

	public MemberRemoveInventory(AdvancedVillages plugin, Village village, Player player,
