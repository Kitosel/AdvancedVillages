...
public class SettingsInventory extends VillageMenu {
	...
	public Inventory getInventory(Village village, Player player) {
		...
		inventory.setItem(23, create(Material.TNT, 1,
				GuiConfig.guis_village_setting_tnt, replaceWith(village, GuiConfig.guis_village_setting_tnt_lore), village.isTnt()));
		inventory.setItem(25, create(Material.NETHERITE_SWORD, 1,
				GuiConfig.guis_village_setting_pvp, replaceWith(village, GuiConfig.guis_village_setting_pvp_lore), village.isPvp()));
