...
public class IndividualPlayerList {
    ...
    public IndividualPlayerList(AdvancedVillages plugin, User user, PlayerListAccessor playerListAccessor, MetaServer metaServer,
    ...
    public void send() {
        ...
        this.metaServer.getPlayer(this.user.getUUID()).peek(player ->
    ...
    private String putVars(String cell) {
        ...
        formatted = plugin.getTablistPlaceholdersService().format(this.user, formatted, Objects.requireNonNull(Bukkit.getPlayer(this.user.getUUID())));
