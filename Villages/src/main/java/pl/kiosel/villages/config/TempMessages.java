...
public class TempMessages {
	...
	public static RawString ptop = new RawString(" &7[{VALUE}&7]");
	public static RawString gtop = new RawString(" &7[&b{VALUE}&7]");
	...
	public static RawString ptopOnline = new RawString("&a");
	public static RawString ptopOffline = new RawString("&c");
}