...
public class TablistConfiguration {
	...
	public String header = "&6Advanced&bVillages";
	public String footer = "&7&lKasa: &a%vault_eco_balance_fixed%";
	...
	public Map<Integer, String> cells = ImmutableMap.<Integer, String>builder()
			...
			.put(22, " &b&lSTATYSTYKI WIOSKI")
			.put(24, " &7Wioska: &b{G-TAG}")
			...
			.put(77, " &7Pozycja wioski: &b{G-POSITION}")
			.build();
