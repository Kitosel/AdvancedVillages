...
public class VillageRegion extends AbstractMutableEntity {
    ...
    public VillageRegion(String name, Location center) {
        this.name = name;
		this.center = Objects.requireNonNull(center, "center").clone();
		this.world = this.center.getWorld();
    }

    public VillageRegion(Village village, Location center, int defaultSize) {
